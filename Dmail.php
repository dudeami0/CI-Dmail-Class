...
/* Features of the CodeIgniter Email Class
 *
 * Multiple Protocols:
 *    - Mail
 *    - Sendmail
...
class Dmail extends CI_Driver_Library {
	...
	public $sendmail_path = 'Z:\XAMPP\sendmail\sendmail';
	...
	public function __construct($config=Array()) {
		$this->valid_drivers = Array('Dmail_mail', 'Dmail_sendmail', 'Dmail_smtp');
	...
	public function _compile_message() {
		...
		if ($parts > 1) {
			...
			$return = "Multipart emails may not work on your client." . $this->newline;
			if ($textCheck) {
